        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Plays = table.Column<ulong>(nullable: false),
                    Avatar = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TagFamilyId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagFamilies", x => x.TagFamilyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikedAuthor", x => new { x.UserId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_UserLikedAuthor_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLikedAuthor_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tags_TagFamilies_FamilyId",
                        column: x => x.FamilyId,
                        principalTable: "TagFamilies",
                        principalColumn: "TagFamilyId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikedAlbum", x => new { x.UserId, x.AlbumId });
                    table.ForeignKey(
                        name: "FK_UserLikedAlbum_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "AlbumId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLikedAlbum_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackAuthor", x => new { x.TrackId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_TrackAuthor_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackAuthor_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "TrackId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikedTrack", x => new { x.UserId, x.TrackId });
                    table.ForeignKey(
                        name: "FK_UserLikedTrack_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "TrackId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLikedTrack_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tags_FamilyId",
                table: "Tags",
                column: "FamilyId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackAuthor_AuthorId",
                table: "TrackAuthor",
                column: "AuthorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLikedAlbum_AlbumId",
                table: "UserLikedAlbum",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikedAuthor_AuthorId",
                table: "UserLikedAuthor",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikedTrack_TrackId",
                table: "UserLikedTrack",
                column: "TrackId");
